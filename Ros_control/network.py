...
train = xlrd.open_workbook('train0.xls')
test = xlrd.open_workbook('test0.xls')
...
model.add(Dense(units=4, activation='tanh'))  # maybe 3
...
model.save('model/'+str(round(test_result[1], 3))+'.h5')